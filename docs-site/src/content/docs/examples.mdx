...
The exact wording, the suggested follow-ups, and which sources appear all
vary by run — the block above is illustrative, but the body of the answer
is constrained to what the `errors_e10_e30.md` entry for E20 actually says
(clogged filter, kinked drain hose, faulty drain pump).
