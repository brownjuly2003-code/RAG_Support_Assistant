...
37 endpoints out of 69 API routes are now in dedicated router files. Latest
sanity: 18/18 experiment tests pass and `/api` route count remains 69
...
| 2i | `/analytics/*` (4) | Group as `api/routers/analytics.py`. |
