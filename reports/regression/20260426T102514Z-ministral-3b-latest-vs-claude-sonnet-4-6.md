...
- Run ID: `20260426T102514Z-b22ac5f7`
- Created at: `2026-04-26T10:25:14.705083+00:00`
...
- Baseline answer: Для гарантийных обращений чек нужно сохранять **не менее 12 месяцев** с момента покупки [2].
- Candidate answer: Не удалось обработать запрос автоматически. Ваш вопрос передан оператору — мы ответим в ближайшее время.
