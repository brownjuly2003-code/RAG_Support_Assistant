...
Add-Gate $gates "mypy strict scope" "python" @("-m", "mypy", "auth", "db", "llm/providers/", "config/settings.py", "agent/state.py", "agent/prompts.py", "agent/prompt_registry.py", "agent/tools.py", "agent/graph.py", "tasks", "utils", "monitoring", "channels", "tracing", "ingestion", "evaluation", "--no-incremental", "--show-error-codes")
Add-Gate $gates "mypy api.app" "python" @("-m", "mypy", "api/app.py", "api/_shared.py", "api/correlation.py", "api/rate_limit.py", "api/routers", "vectordb", "--no-incremental", "--follow-imports=skip", "--show-error-codes")
