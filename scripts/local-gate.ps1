...
Add-Gate $gates "mypy strict scope" "python" @("-m", "mypy", "auth", "db", "llm/providers/", "config/settings.py", "agent/state.py", "agent/prompts.py", "agent/prompt_registry.py", "agent/tools.py", "agent/graph.py", "tasks", "utils", "monitoring", "channels", "tracing", "ingestion", "--no-incremental", "--show-error-codes")
