...
> **ПРОГНАН 2026-07-18, вердикт NO-SHIP по всем плечам** — результаты и
> интерпретация: `2026-07-18-q1-context-precision-ab-results.md`. Прод-дефолты
> не меняются. Оценка времени embed ниже занижена (реальный корпус 5589 чанков
> → ~2.2 ч на mps batch 8, полный прогон ~7 ч).
