...
`transport error: read timed out / server disconnected / DNS` — узел штатно
деградировал к «оставить документы» на этих кейсах. Направление вердикта это
не меняет: деградированные кейсы ведут себя как prod и не могут дать регрессию
FULL — наблюдаемые регрессии grade-плеч пришли от кейсов, где фильтр РЕАЛЬНО
сработал и убрал полезные документы. Полностью здоровый grade фильтровал бы
больше, то есть измеренные регрессии — нижняя оценка. Embed-стадия также шла
~2.2 ч вместо «3–6 мин» из плана: корпус aircargo = 5589 чанков, а не «сотни»
(оценка в плане была занижена; сам прогон от этого только дольше, не хуже).
