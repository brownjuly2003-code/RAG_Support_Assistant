...
> **ИТОГ (2026-06-06): проверено плечом F — NO-SHIP.** Гипотеза подтвердилась
> до экспансии (F-pre 92 vs D2-pre 87), но parent-expansion поглощает выигрыш:
> полный стек F = 95 < D2 = 96 (1 gain / 2 регрессии), gain целевого кейса не
> сохранился (его закрывал expanded-реранк, не пулы). Разбор:
> `2026-06-06-arm-f-split-query-results.md`. Цикл query-expansion закрыт.
